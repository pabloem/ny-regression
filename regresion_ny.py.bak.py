...
International Geology Review 38.4 (1996): 293-303.
...
#    Wy = list()
    ...
    puntos = int(raw_input("Cuantos puntos vas a introducir? "))
    i = 0
    while i < puntos:
        X.append(float(raw_input("x"+str(i+1)+": ")))
#        Wx.append(float(raw_input("Peso x"+str(i+1)+": ")))
        Y.append(float(raw_input("y"+str(i+1)+": ")))
#        Wy.append(float(raw_input("Peso y"+str(i+1)+": ")))
        i+=1
    return (X,Y)
#    return (X,Wx,Y,Wy)
